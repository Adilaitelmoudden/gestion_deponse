...
@section('header', 'Ajouter une Transaction')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-plus-circle"></i> Nouvelle Transaction</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="d-flex gap-3">
                            <div class="form-check">
                                <input type="radio" name="type" id="type_expense" value="expense" 
                                       class="form-check-input" {{ old('type', 'expense') == 'expense' ? 'checked' : '' }} required>
                            ...
                            <div class="form-check">
                                <input type="radio" name="type" id="type_income" value="income" 
                                       class="form-check-input" {{ old('type') == 'income' ? 'checked' : '' }}>
